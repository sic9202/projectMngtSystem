...
<head>
    ...
    <meta name="description" content="사전환경 관리">
    <meta property="og:description" content="사전환경 관리">
...
<body>
    ...
    <div class="sub-visual sv01 on">
      <p class="animated on">사전환경 리스트</p>
    </div>

    <!-- container start-->
    <div class="pr-page">
      <div id="inner02" class="inner02">
        <p class="sub__tit01"> 사전환경 리스트 <span class="sub__tit02"></span></p>
          ...
          <div class="board_tbl_box">
            <table id="datasetList" class="tbl_board notice">
              ...
              <tbody>
              	<tr>
              		<td>1</td>
					<td class="sbj txtL"><a style="cursor:pointer;" onclick="goWorkList()">등록된 데이터입니다.</a></td>
					<td>2022-10-17</td>
					<td>inchul shin</td>
              </tbody>
            </table>
